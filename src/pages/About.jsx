  ...
  return (
    ...
    >
      <p>
        ...
        Aimyを継続して遊び、衣装とガチャを記録している個人が運営する
        非公式のファンデータベースです。
      </p>
      ...
      <section className="legal-section">
        <h2>誰が・どのように作っているか</h2>
        <p>
          Aimy Closet運営者（個人）が、ゲーム内画面の記録、自動切り抜き、
          公開前の目視確認、誤りの修正まで行っています。単なる画像一覧ではなく、
          開始順、カテゴリ、初回・再収録、追加間隔を同じ基準で集計し、
          判定方法も公開しています。
        </p>
      </section>
