const gacha = {
  ...
  items: [
    ...
    { id: 'hydrangea-ajisai-head-dress', rarity: 'SR', category: 'あたま', name: '紫陽花ヘッドドレス', image: '/images/items/hydrangea/08.png' },
    { id: 'hydrangea-ajisai-twin-ribbon', rarity: 'SR', category: 'あたま', name: '紫陽花ツインリボン', image: '/images/items/hydrangea/09.png' },
    { id: 'hydrangea-pink-ribbon-head-dress', rarity: 'SR', category: 'あたま', name: 'ピンクリボンのヘッドドレス', image: '/images/items/hydrangea/10.png' },
